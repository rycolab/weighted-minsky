...
from fsrnn.base.semiring import Semiring
from fsrnn.base.state import PairState, State
from fsrnn.base.symbol import Sym, ε, ε_1, ε_2
...
class FST(FSA):
    ...
    def compose(self, fst: "FST", augment: bool = True) -> "FST":
        from fsrnn.base.fsa_classes import get_epsilon_filter
